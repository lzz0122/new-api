...
const defaultOperationsSettings: OperationsSettings = {
  ...
  'channel_health_setting.failure_threshold': 3,
  'channel_health_setting.probe_interval_seconds': 600,
  'channel_health_setting.probe_batch_size': 10,
  'channel_health_setting.manual_probe_cooldown_seconds': 10,
  SMTPServer: '',
  SMTPPort: '',
  SMTPAccount: '',
  SMTPFrom: '',
